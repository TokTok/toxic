 ...
 */
static int complete_line_helper(ToxWindow *self, char **list, const size_t n_items, bool dir_search)
{
...
int complete_line(ToxWindow *self, char **list, size_t n_items)
{
    return complete_line_helper(self, list, n_items, false);
}

static int complete_path(ToxWindow *self, char **list, const size_t n_items)
{
...
int dir_match(ToxWindow *self, Tox *m, const wchar_t *line, const wchar_t *cmd)
{
    ...
    int ret = complete_path(self, dirnames, dircount);
