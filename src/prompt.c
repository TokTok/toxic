...
void kill_prompt_window(Toxic *toxic, const Client_Config *c_config)
{
...
void prompt_update_nick(Toxic *toxic, const char *nick)
{
    StatusBar *statusbar = toxic->home_window->stb;
...
void prompt_update_status(Toxic *toxic, Tox_User_Status status)
{
    StatusBar *statusbar = toxic->home_window->stb;
...
void prompt_init_statusbar(Toxic *toxic, bool first_time_run)
{
    ...
    prompt_update_status(toxic, status);
    prompt_update_nick(toxic, nick);
